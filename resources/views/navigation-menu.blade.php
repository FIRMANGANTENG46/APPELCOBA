<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(Auth::user()->roles == 'ADMIN')
                        <x-jet-nav-link href="{{ route('dashboard.pertemuan.index') }}" :active="request()->routeIs('dashboard.pertemuan.index')">
                            {{ __('Pertemuan') }}
                        </x-jet-nav-link>

                        <x-jet-nav-link href="{{ route('dashboard.materi.index') }}" :active="request()->routeIs('dashboard.materi.index')">
                            {{ __('Materi') }}
                        </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->roles == 'ADMIN')
                <x-jet-responsive-nav-link href="{{ route('dashboard.pertemuan.index') }}" :active="request()->routeIs('dashboard.pertemuan.index')">
                    {{ __('Pertemuan') }}
                </x-jet-responsive-nav-link>
